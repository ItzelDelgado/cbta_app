@php
    // Hacemos esto para no tener que estar modificando el código de la parte de menu hamburguesa y menu grande.
    $links = [
        [
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endforeach
            @guest <!-- Si esta logueado no sale esto -->
        ...
        @auth
            <!-- Responsive Settings Options - SOLO SE MUESTRA SI HEMOS INICIADO SESION-->
