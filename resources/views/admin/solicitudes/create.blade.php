<x-admin-layout>
    ...
    <div class="flex flex-col items-center">
        ...
        <form action="{{ route('admin.solicitudes.store') }}" method="POST" class="bg-white rounded-lg p-6 shadow-lg">
            ...
            <x-input-solicitud value="{{old('denominacion_generica')}}" name="denominacion_generica" class="" placeholder="Escriba la denominacion genérica del medicamento" />
        </div>
        <div class="mb-4">
            <x-label class="mb-2">
                Denominación comercial
            </x-label>
            <x-input-solicitud value="{{old('nombre_comercial')}}" name="nombre_comercial" class="" placeholder="Escriba la denominacion comercial del medicamento" />
        </div>
        ...
        <div class="mb-4">
            ...
            <x-input-solicitud value="{{old('presentacion_ml')}}" name="presentacion_ml" class="" placeholder="Escriba la presentación del medicamento" />
        </div>
        ...
        <div class="mb-4">
            ...
            <x-input-solicitud  type="number" value="{{old('osmolaridad')}}" name="osmolaridad" class="" placeholder="Escriba la osmolaridad" />
        </div>
        ...
        <div class="mb-4">
            ...
            <x-input-solicitud type="number" value="{{old('precio_ml')}}" step="0.001" name="precio_ml" class="" placeholder="Escriba el precio por ml del medicamento" />
        </div>
        <div class="mb-4">
            <x-label class="mb-2">
                Categoría
