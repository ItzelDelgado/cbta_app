    ...
    <div class="mt-2">
        <div class="mb-4">
            <h1 class="text-2xl font-semibold text-gray-800">
                Presentaciones de: {{ $diluent->denominacion_generica ?? '—' }}
            </h1>
            <div class="mt-2">
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-100 text-gray-600">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left">Denominación comercial</th>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('admin.oncologicos.diluent_presentations.edit', [$diluent, $p]) }}"
                                   class="px-3 py-1 bg-amber-500 text-white rounded hover:bg-amber-600">Editar</a>
