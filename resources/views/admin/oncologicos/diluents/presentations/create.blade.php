<x-admin-layout>
    <div class="mt-2 max-w-3xl">
        <h1 class="text-2xl font-semibold text-gray-800 mb-4">
            Nueva presentación para: {{ $diluent->denominacion_generica ?? '—' }}
        </h1>
        ...
        <form action="{{ route('admin.oncologicos.diluent_presentations.store', $diluent) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0.01" name="volume_ml" value="{{ old('volume_ml') }}" required
                           class="w-full px-3 py-2 border rounded focus:ring focus:ring-blue-200 focus:outline-none">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Denominación comercial</label>
                    <input type="text" name="denominacion_comercial" value="{{ old('denominacion_comercial') }}"
