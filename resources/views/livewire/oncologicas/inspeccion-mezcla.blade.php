            ...
            <div class="bg-white rounded-lg shadow-lg w-full max-w-6xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div>
                                <label for="tipo_contenedor" class="block text-sm font-medium text-gray-700">Tipo de contenedor</label>
                    ...
                    <div>
                        <div class="space-y-3">
                            <div>
                                <label for="dosis_volumen" class="block text-sm font-medium text-gray-700">Dosis Volumen (ml)</label>
                                <input type="number" step="0.01" wire:model.defer="dosis_volumen" id="dosis_volumen"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200" />
                            </div>

                            <div>
                                <label for="peso_mezcla" class="block text-sm font-medium text-gray-700">Peso de la Mezcla (g)</label>
                            ...
                            <div>
                                <label for="reviso_nombre" class="block text-sm font-medium text-gray-700">Nombre de quien revisó</label>
                                <input type="text" wire:model.defer="reviso_nombre" id="reviso_nombre"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200" />
                            </div>

                            <div>
                                <label for="aprobo_nombre" class="block text-sm font-medium text-gray-700">Nombre de quien aprobó</label>
    ...
    <script>
        function toggleCheckboxes() {
            ...
            checkboxes.forEach(cb => {
                ...
                cb.dispatchEvent(new Event('change', { bubbles: true })); // ✅ cambio importante
            });
        }
    </script>
</div>
